  method if_cts_hot_logger~warning_exception.
    ...
    if ix_exception is instance of cx_cts_exception.
      ...
      me->if_cts_hot_logger~long_text( iv_level = if_cts_hot_logger=>co_level_3
                                       iv_severity =  if_cts_hot_logger=>co_severity_warning
    ...
    if ix_exception->previous is bound.
      me->if_cts_hot_logger~warning_exception( ix_exception->previous ).
    endif.
  endmethod.