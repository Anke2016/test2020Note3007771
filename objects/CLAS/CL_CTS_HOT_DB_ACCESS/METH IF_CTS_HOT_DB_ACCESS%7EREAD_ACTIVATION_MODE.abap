  METHOD if_cts_hot_db_access~read_activation_mode.
    SELECT SINGLE value FROM cts_hot_params INTO @DATA(lv_activation_mode) WHERE name = @if_cts_hot_db_access=>co_name_hot_activation_mode.
    ...
    CASE lv_activation_mode.
      ...
      WHEN OTHERS.
        ...
        "if changed here, also change messages SCTS_HOT 539 and 614
        r_result = if_cts_hot_db_access~co_hot_activation_mode_ok.
    ENDCASE.
  ENDMETHOD.